...
function _loadAndParseIgnores(ignorePath) {
    return path.existsSync(ignorePath) ?
...
function _mergeIgnores(defaultIgnorePath, projectIgnorePath) {
    var defaultIgnores = _loadAndParseIgnores(defaultIgnorePath),
        projectIgnores = _loadAndParseIgnores(projectIgnorePath);

    return defaultIgnores.concat(projectIgnores).filter(function (s, i, a) {
...
module.exports = {
    interpret: function (args) {
        var config, reporter, ignore,
            ...
            defaultIgnore = path.join(process.env.HOME, '.jshintignore'),
            projectIgnore = path.join(process.cwd(), '.jshintignore'),
        ...
        ignore = _mergeIgnores(defaultIgnore, projectIgnore);
